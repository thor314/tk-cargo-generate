mod demo {
    ...
    #[fixture]
    fn workbench(#[default(false)] b: bool, count: usize) -> TestWorkbench { TestWorkbench { b, count } }
    ...
    fn test_workbench(workbench: TestWorkbench, #[case] n: usize, #[case] b: bool, #[case] expected: bool) {
